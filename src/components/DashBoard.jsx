...
const DashBoard = () => {
  ...
  return (
    <div className="w-full h-full bg-gray-100 p-6 flex gap-6">
      <div className="w-8/12 flex flex-col gap-6">
        <div className="bg-white rounded-xl shadow-sm px-6 py-5">
            <div className="flex items-center justify-between mb-4">
            <div>
                <h2 className="text-lg font-semibold text-gray-900">Spending Statistics</h2>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm px-6 py-5 flex items-center justify-between">
            <div className="flex-1">
                ...
                <div className="flex justify-between items-center mb-3">
                    <h3 className="text-black text-base font-medium">Total Income</h3>
                ...
                <div className="flex items-end gap-2 mb-5">
                    <h1 className="text-[32px] font-bold text-gray-800">$50,530.00</h1>
                    <span className="text-[#90A3BF] font-semibold text-sm mb-2">(USD)</span>
                </div>

                <p className="text-sm">
                    <span className="text-[#7FB519] font-medium">20%</span>
                    <span className="text-[#90A3BF] font-medium"> increase compared to last week</span>
                </p>

            </div>

            <div className="w-px h-24 bg-gray-200 mx-6"></div>

            <div className="flex-1">

            <div className="flex justify-between items-center mb-3">
                <h3 className="text-black text-base font-medium">Total Expense</h3>
            ...
            <div className="flex items-end gap-2 mb-5">
                <h1 className="text-[32px] font-bold text-gray-800">$19,760.00</h1>
                <span className="text-[#90A3BF] font-semibold text-sm mb-2">(USD)</span>
            </div>

            <p className="text-sm mb-2">
                <span className="text-[#FF4423] font-medium">10%</span>
                <span className="text-[#90A3BF] font-medium"> decrease compared to last week</span>
            </p>
        ...
        <div className="bg-white rounded-xl shadow-sm px-6 py-5">
            <div className="flex !justify-between items-center mb-8">
                ...
                <DatePicker 
                    ...
                    customInput={
                        <button className="flex items-center gap-2 border-2 border-[#C3D4E9] px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-50">
                            <MdCalendarMonth size={20} /> {startDate.toDateString()}
                        </button>
                    }
            />
            </div>

            <div className="grid grid-cols-4 text-gray-400 text-sm border-b border-t py-3 mb-3">
                <span className=' text-[#90A3BF] cursor-pointer'>Transactions</span>
                <span className="flex items-center gap-1 text-[#90A3BF] cursor-pointer">Date<FaAngleDown /></span>
                <span className="flex items-center gap-1 text-[#90A3BF] cursor-pointer">Amount <FaAngleDown /></span>
                <span className="flex items-center gap-1 text-[#90A3BF] cursor-pointer">Status <FaAngleDown /></span>
            </div>
            ...
            <div className="grid grid-cols-4 items-center py-4 border-b">
                ...
                <span className="text-gray-800 font-semibold">Jan 01,2022</span>
                <span className="text-gray-800 font-semibold">$2,000.00</span>
            ...
            <div className="grid grid-cols-4 items-center py-4 border-b">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-700 font-medium">Paypal Account</span>
                </div>

                <span className="text-gray-800 font-semibold">Jan 04,2022</span>
                <span className="text-gray-800 font-semibold">$2,000.00</span>
            ...
            <div className="grid grid-cols-4 items-center py-4">
                ...
                <span className="text-gray-800 font-semibold">Jan 06,2022</span>
                <span className="text-gray-800 font-semibold">$2,000.00</span>
      ...
      <div className="w-4/12 flex flex-col gap-6">
        <div className="bg-white rounded-xl shadow-sm px-6 py-5">
          ...
          <div className="flex items-end gap-2 mb-4">
            <h1 className="text-[32px] font-bold text-gray-800">$120,435.00</h1>
            <span className="text-[#90A3BF] font-semibold text-sm mb-2">(USD)</span>
          </div>
          ...
          <div className="flex justify-between gap-4">
            <button className="flex items-center gap-2 bg-teal-500 text-white px-8 py-4 rounded-xl hover:bg-teal-600 transition">
              <img src={Recivemony} alt="Recivemony" className="w-6 h-6" />
              Top Up
            </button>
            <button className="flex items-center gap-2 border-2 border-teal-500 text-teal-600 px-8 py-4 rounded-xl hover:bg-teal-50 transition">
              <img src={Sendmony} alt="Sendmony" className="w-6 h-6" />
              Transfer
            </button>
          </div>
        </div>
